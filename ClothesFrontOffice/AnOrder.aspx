...
<body>
    <form id="form1" runat="server">
        ...
        <table class="auto-style1">
            ...
            <tr>
                <td class="auto-style6" id="Order_Date">Order_Date:</td>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    ...
                    <asp:Button ID="ButtonCancel" runat="server" Height="45px" OnClick="Button1_Click" style="font-weight: 700; background-color: #FFFFCC" Text="Cancel" Width="122px" />
